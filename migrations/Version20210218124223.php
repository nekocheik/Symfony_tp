 ...
 */
final class Version20210218124223 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE statistic CHANGE client_id_id client_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE statistic CHANGE client_id client_id_id INT NOT NULL');
